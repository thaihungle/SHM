...
from envs.credit_assign.key_to_door import visual_match
...
register(
    "VisualMatch-SR-v0",
    entry_point="envs.credit_assign.key_to_door.tvt_wrapper:VisualMatch",
    kwargs=dict(
        flatten_img=True,
        one_hot_actions=False,
        apple_reward=1.0,
    ...
    max_episode_steps=sum(visual_match.MAX_FRAMES_PER_PHASE.values()),
)