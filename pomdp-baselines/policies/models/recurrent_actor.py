...
class Actor_RNN(nn.Module):
    def __init__(
        ...
        **kwargs
        ...
        encoder = GRU_name #save computing resources
        ...
        for name, param in self.rnn.named_parameters():
            ...
            elif "weight" in name and "norm" not in name and "ln_" not in name and param.requires_grad:
    ...
    def get_initial_info(self):
        ...
        elif self.encoder == FFM_name or self.encoder == SHM_name:
            internal_state = self.rnn.get_initial_state()
        else:
