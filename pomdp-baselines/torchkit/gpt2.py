...
class GPT2Agent(nn.Module):
	...
	def __init__(
		...
		**kwargs
		...
		self.map = nn.Linear(input_size, hidden_size)
	...
	def forward(self, input_embeds, h_0 = None):
		"""
		input_embeds:
			training -- (max_seq_length, B, input_dim)
			eval -- (1, 1, input_dim)
		"""
		input_embeds = self.map(input_embeds)
	...
	def get_initial_state(self):
		return self.get_zero_internal_state()